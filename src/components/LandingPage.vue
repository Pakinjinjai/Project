			...
			<section class="box special features">
				<div class="features-row">
					<section>
						<div class="relative w-full" style="padding-top: 100%;">
							<span class="absolute inset-0 flex items-center justify-center">
								<span class="inline-block bg-[#9BB0C1] p-2 rounded-lg">
									<svg class="h-full w-full" style="enable-background:new 0 0 50 50;" version="1.1"
					...
					<section>
						<div class="relative w-full" style="padding-top: 100%;">
							<span class="absolute inset-0 flex items-center justify-center">
								<span class="inline-block bg-[#51829B]  p-2 rounded-lg">
									<svg class="h-full w-full" xmlns="http://www.w3.org/2000/svg" fill="none"
										viewBox="0 0 24 24">
				...
				<div class="features-row">
					<section>
						<div class="relative w-full" style="padding-top: 100%;">
							<span class="absolute inset-0 flex items-center justify-center">
								<span class="inline-block bg-[#F6995C] p-2 rounded-lg">
					...
					<section>
						<div class="relative w-full" style="padding-top: 100%;">
							<span class="absolute inset-0 flex items-center justify-center">
								<span class="inline-block bg-[#EADFB4] p-2 rounded-lg">
									<svg class="h-full w-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"
										id="heart">
