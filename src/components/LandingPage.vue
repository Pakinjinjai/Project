				...
				<div class="features-row">
					<section>
						<span class="icon solid major fa-bolt accent2 "> 
								...
								xml:space="preserve" xmlns="http://www.w3.org/2000/svg" width="64" height="64"
					...
					<section>
						<span class="icon solid major fa-chart-area accent3 p-6">
							<svg class=" " xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="none" viewBox="0 0 24 24"
								id="heal">
