...
<section class="box special features">
    <div class="features-row">
        <section>
            ...
            <h3>ความดันโลหิต</h3>
            <p>ความดันโลหิต คือ แรงดันภายในหลอดเลือดแดง ที่เกิดจากการบีบตัวของหัวใจ เพื่อส่งเลือดไปเลี้ยงส่วนต่างๆ ของร่างกาย ประกอบด้วยเลข 2 ค่า คือ

<br>ค่าสูง เป็นค่าแรงดันในหลอดเลือดแดงขณะหัวใจบีบตัว (Systolic Blood Pressure)

<br>ค่าต่ำ เป็นค่าแรงดันในหลอดเลือดแดงขณะหัวใจคลายตัว (Diastolic Blood Pressure)

ความดันโลหิตมีการเปลี่ยนแปลงขึ้นๆ ลงๆ ตลอดทั้งวัน ซึ่งการตรวจวัดความดันในเวลาที่ต่างกันไม่จำเป็นต้องมีค่าเท่ากันเสมอไป ทั้งนี้ขึ้นอยู่กับปัจจัยกระตุ้นต่างๆ</p>
        </section>
        <section>
            ...
            <p>ระดับออกซิเจนในเลือดมีความเป็นปกติ (Normal ABG oxygen level) ค่าความอิ่มตัวของออกซิเจนในเลือดอยู่ที่ 96-99%เป็นสภาวะที่เหมาะสมที่สุดต่อร่างกาย เป็นค่าวัดสำหรับผู้ที่มีสุขภาพและปอดที่แข็งแรงจะอยู่ระหว่าง 80 ถึง 100 มิลลิเมตรปรอท หากวัดระดับออกซิเจนในเลือด (SpO2) ค่าปกติจะอยู่ระหว่าง 95-100%</p>
        </section>
    </div>
    <div class="features-row">
        <section>
            ...
            <p>อุณหภูมิร่างกาย (Body Temperature) คือ ระดับสมดุลความร้อนในร่างกายซึ่งจะมีความผันแปรไปตามปัจจัยรอบตัว รวมไปถึงเกิดจากการสร้างความร้อนของกระบวนการเมตาบอลิซึม (Metabolism) ในร่างกาย อุณหภูมิร่างกายจะมีศูนย์ควบคุมสำคัญอยู่ที่สมองส่วนไฮโปทาลามัส (Hypothalamus) ซึ่งจะตั้งอุณหภูมิร่างกายปกติอยู่ที่ประมาณ 37 องศาเซลเซียส</p>
        </section>
        <section>
            ...
            <p>ค่าอัตราการเต้นของหัวใจ (Heart Rate) หรือชีพจรที่เต้นวัดเป็นจำนวนครั้งต่อนาที ค่าดังกล่าวจะสะท้อนให้เห็นการทำงานของหัวใจ หรือระบบไหลเวียนเลือด เนื่องจากในทุกๆ ครั้งที่หัวใจเต้น หัวใจจะทำหน้าที่สูบฉีดเลือดไปหล่อเลี้ยงทั่วร่างกายนั่นเอง โดย อัตราการเต้นของหัวใจในแต่ละวัย จะมีตัวเลขที่ต่างกันไป</p>
        </section>
    </div>
</section>
