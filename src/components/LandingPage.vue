		...
		<section id="main" class="container">
			...
			<section class="box special features">
				<div class="features-row">
					<section>
						<span class="icon solid major fa-bolt accent2 mx-auto"><svg xmlns="http://www.w3.org/2000/svg"
								width="64" height="64" id="wave">
								<path
									...
									transform="translate(0 -988.362)" style="
                    text-indent: 0;
                    text-align: start;
                    line-height: normal;
                    text-transform: none;
			...
			<div class="row">
				<div class="col-6 col-12-narrower">
					<section class="box special">
						<span class="image featured"><img src="../assets/pugun.jpeg" alt="../assets/pugun.jpeg" /></span>
						<h3>นาย ภาคิน จิ้นจ้าย</h3>
						<p>
				...
				<div class="col-6 col-12-narrower">
					<section class="box special">
						<span class="image featured"><img src="../assets/pugun.jpeg" alt="../assets/doctorwo.jpeg" /></span>
						<h3>นาย ศตพรรษ จำปา</h3>
						<p>
							Integer volutpat ante et accumsan commophasellus sed aliquam
							feugiat lorem aliquet ut enim rutrum phasellus iaculis accumsan
							dolore magna aliquam veroeros.
