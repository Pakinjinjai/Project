  ...
  <div class="container flex flex-col items-center gap-16 mx-auto mt-8">
    <div class="grid w-full grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-2">
      ...
      <div
        class="flex flex-col items-center gap-3 px-8 py-10 bg-white rounded-3xl hover:shadow shadow-main"
      >
        <p class="flex text-xl text-dark-grey-900"> ค่าอุณภูมิร่างกาย <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" class="tem" id="tem"><path d="M57.5 45H65v5h-7.5z"></path><path d="M50 5c-8.284 0-15 6.716-15 15v41.802c-3.103 3.524-5 8.134-5 13.198 0 11.046 8.954 20 20 20 .36 0 .723-.01 1.087-.029 10.33-.547 18.674-9.169 18.908-19.511.119-5.245-1.798-10.028-4.995-13.658V55h-7.5v9.633l1.871 2.125a12.456 12.456 0 0 1 3.125 8.532c-.144 6.385-5.441 11.854-11.806 12.191-.23.013-.461.019-.69.019-6.893 0-12.5-5.607-12.5-12.5a12.47 12.47 0 0 1 3.129-8.242l1.871-2.125V20c0-4.135 3.365-7.5 7.5-7.5s7.5 3.365 7.5 7.5H65c0-8.284-6.716-15-15-15z"></path><path d="M57.5 35H65v5h-7.5zM57.5 25H65v5h-7.5zM47.5 35v32.938c-2.908 1.033-5 3.804-5 7.063 0 4.136 3.364 7.5 7.5 7.5s7.5-3.364 7.5-7.5c0-3.258-2.092-6.03-5-7.063V35h-5z"></path></svg></p>
        <span
          ><p class="text-base leading-7 text-dark-grey-600 flex items-center">
            <input
